...
var store = function (city, minCust, maxCust, aveCookiesHour, ttlCookiesDay) {
  this.city = city;
...
store.prototype.randoCust = function () {
  return Math.floor(Math.random() * (this.maxCust - this.minCust + 1) + this.minCust);
  };

store.prototype.cookiesPerHour = function() {
  for (var i = 0; i < storeHours.length; i++) {
    var cookieSales = Math.round(this.randoCust() * this.avgCookiesCust);
    this.avgCookiesHour.push(cookieSales);
  }
  storeHourlySales.push(this.hourlySales);
};
